...
function CadenBio() {
    ...
    return <div style={style}>
        Caden Michaels
        <div style={style2}>
            {"Caden Michaels grew up spending time amidst the rolling hills and countryside of northwest Connecticut, where his family had a home with vegetable gardens and fruit-bearing trees. From a young age, Caden found joy in the autumn months when the apple trees would be heavy with fruit. Every fall, he and his brother, joined by friends, would gather apples from the three trees. But as the baskets overflowed, it became clear that they had more than they could ever eat or store. Rather than letting the fruit go to waste, Caden’s family found a purpose for their bounty. They began loading up the apples and bringing them to a food shelter in Brooklyn, just across the street from the elementary school that Caden and his brother attended. This simple act sparked a bigger idea. What started as a way to share the excess fruit with those in need soon grew into a family tradition. From these beginnings, The Big Wild Apple was born—a name that captures the connection between the Wile fruit trees of the Connecticut countryside with the heart of the The Big Apple."}
        </div>
    </div>
}
