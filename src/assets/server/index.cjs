...
db.run("CREATE TABLE IF NOT EXISTS transfers([window] TEXT, [estateID] INTEGER NOT NULL, [dropoffID] INTEGER NOT NULL, [userID] INTEGER NOT NULL, [isConfirmed] INTEGER NOT NULL, [transferID] INTEGER PRIMARY KEY NOT NULL)")
